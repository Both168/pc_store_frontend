      ...
      <div class="flex flex-col md:flex-row gap-8">
        ...
        <div class="md:w-1/2 md:sticky md:top-24 md:self-start">
          <div class="flex flex-col md:flex-row gap-4 items-stretch">
            <!-- Main Image -->
            <div v-if="images && images.length > 0" class="neumorphic-card main-image-container flex-1 order-1 md:order-2">
              <img
            ...
            <div v-if="images && images.length > 1" class="thumbnail-outer-container order-2 md:order-1">
          ...
          <div v-if="description && showDescriptionOnLeft" class="neumorphic-card p-6 mt-6 hidden md:block">
        ...
        <div class="md:w-1/2 md:sticky md:top-24 md:self-start">
          <div class="neumorphic-card content-container space-y-6 px-6 py-6">
            ...
            <!-- Description Below Specifications (Desktop only if not on left) -->
