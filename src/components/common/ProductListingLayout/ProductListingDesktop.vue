  ...
  <div class="product-listing-desktop">
    ...
    <div class="pb-12 px-4 sm:px-6 lg:px-8">
      <div class="max-w-7xl mx-auto">
        ...
        <div v-if="loading" class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          <slot name="skeleton">
        ...
        <!-- Product Cards Grid -->
        <div v-else-if="items && items.length > 0" class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
