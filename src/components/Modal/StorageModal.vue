      ...
      <div v-if="modelValue" class="modal-overlay" @click.self="close">
        <div class="modal-container neumorphic-card">
          <div class="modal-header">
            <h2 class="modal-title">Add Storage</h2>
          ...
          <div class="modal-body">
            <StorageFilter v-model="filters" />
            <div v-if="isLoading" class="modal-cards-loading">Loading storage...</div>
            <template v-else>
...
import StorageFilter from '../pc_part_filter/StorageFilter.vue'
import LaptopCard from '../common/LaptopCard.vue'
import crossCircleIcon from '../../assets/icons/setup/cross-circle.png'
import Pagination from '../common/Pagination.vue'
import { fetchStorageCards, type StorageCard } from '../../services/apiComponent'
...
async function load() {
  ...
  try {
    ...
    const result = await fetchStorageCards(f)
