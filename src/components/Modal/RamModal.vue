      ...
      <div v-if="modelValue" class="modal-overlay" @click.self="close">
        <div class="modal-container neumorphic-card">
          <div class="modal-header">
            <h2 class="modal-title">Add RAM</h2>
          ...
          <div class="modal-body">
            <RamFilter v-model="filters" />
            <div v-if="isLoading" class="modal-cards-loading">Loading RAM...</div>
            <template v-else>
...
async function load() {
  ...
  try {
    ...
    const result = await fetchRamCards(f)
